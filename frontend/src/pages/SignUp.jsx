...
function SignUp() {
  ...
  return (
    <div className='bg-[#dddbdb] w-[100vw] h-[100vh] flex items-center justify-center flex-col'>
        <form className='w-[90%] md:w-150 h-118 bg-[white] shadow-xl rounded-2xl flex' onSubmit={(e)=>e.preventDefault()}>
            <div className='md:w-[50%] w-[100%] h-[100%] flex flex-col items-center justify-center gap-2'>
            ...
            <span className='text-[white] text-2xl'>AIPathway</span>
            </div>
